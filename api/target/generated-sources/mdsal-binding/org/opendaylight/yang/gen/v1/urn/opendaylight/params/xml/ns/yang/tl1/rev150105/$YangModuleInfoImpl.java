...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "tl1";
    private final String namespace = "urn:opendaylight:params:xml:ns:yang:tl1";
    private final String revision = "2015-01-05";
    private final String resourcePath = "/META-INF/yang/tl1.yang";
